...
const ProductOverview = () => {
    return (
        <div className='max-w-[15vw] min-w-[15vw]   mr-2 bg-blend-multiply bg-gray-100' >
            <img src="https://m.media-amazon.com/images/I/41tps1-sn4L._SR480,440_.jpg" alt="" className='bg-[#f9f9f9] mix-blend-multiply' />
